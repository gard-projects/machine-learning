...
Since the two inner terms of the multiplication is equal, the matrix multiplication will be successful. As a question for the reader, what would happen if the multiplication was in the reverse order $\textemdash$ that is $\theta \cdot X$?
